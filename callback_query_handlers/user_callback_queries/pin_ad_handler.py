...
async def pin_ad_handler(callback_query: CallbackQuery):
    ...
    inline_btn1 = InlineKeyboardButton('Подтвердить', callback_data=f'confirmPinAd_{ad_index}')
    inline_btn2 = InlineKeyboardButton('Назад', callback_data=f'cancelPinAd_{ad_index}')
